...
public class Admin extends JFrame 
{
	...
	public Admin(int id)
	{
		...
		textPane.setText("enter the question");
		JLabel panel=new JLabel(new ImageIcon(Admin.class.getResource("/images/welcome1.jpg")));
		panel.setBounds(0,100,340,250);
		JLabel lb1=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
		JLabel lb2=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
		JLabel lb3=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
		...
		JLabel info=new JLabel(new ImageIcon(Admin.class.getResource("/images/pr2.jpg")));
		...
		JLabel prof = new JLabel(new ImageIcon(Admin.class.getResource("/images/p6.png")));
		prof.setBounds(95, 80, 140, 100);
 		...
 		t5.setVisible(false);
 		JLabel s=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
 		
 		
 		s.setBounds(50,350,100,30);
 		lblNewLabel_2.add(s);
 		s.setVisible(false);
 		JLabel save = new JLabel("SUBMIT");
 		...
 		s.add(save);
 		JLabel c=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
 		...
 		c.add(cancel);
 		JLabel d=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
 		d.setBounds(50,350,100,30);
 		lblNewLabel_2.add(d);
 		d.setVisible(false);
 		
 		JLabel u=new JLabel(new ImageIcon(Admin.class.getResource("/images/image.jpg")));
			 		u.setBounds(50,350,100,30);
			 		lblNewLabel_2.add(u);
			 		u.setVisible(false);
							 		
							 				
JLabel l2=new JLabel("DELETE ALL ");
l2.setHorizontalAlignment(SwingConstants.CENTER);
JLabel l3=new JLabel("UPLOAD NOTES");
l3.setHorizontalAlignment(SwingConstants.CENTER);
JLabel l1=new JLabel(" ADD QUESTION");
