...
public class Dashborad1 extends JFrame
{
	...
	private void initialize() 
	{
		...
		JButton btnAddComment = new JButton("AddComment");
		...
		JLabel lblStartQuiz = new JLabel("START QUIZ   ");
		...
		JLabel btnProfile = new JLabel("           PROFILE   ");
		...
		JLabel lblprofileback = new JLabel("");
	...
	public void getLeaderBoard(int n)
	{
...
//		}
	...
	public JLabel lbl(String filename)
	{
		JLabel l;
		l=new JLabel("");
